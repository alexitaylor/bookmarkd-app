...
> = {
	...
	"The Name of the Wind": [
		...
		{
			number: 6,
			title: "The Price of Remembering",
			startPage: 53,
			endPage: 68,
		},
		{
			number: 7,
			title: "Of Beginnings and the Names of Things",
			startPage: 69,
			endPage: 84,
		},
		{
			number: 8,
			title: "Thieves, Heretics, and Whores",
			startPage: 85,
			endPage: 98,
		},
		{
			number: 9,
			title: "Riding in the Wagon with Ben",
			startPage: 99,
			endPage: 114,
		},
		{
			number: 10,
			title: "Alar and Several Stones",
			startPage: 115,
			endPage: 130,
		},
	],
